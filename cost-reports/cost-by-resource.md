...
|---|---|---|---|---|---|---|---:|
|arm | microsoft.security/pricings | Unassigned |  |  Advanced Threat Protection | Azure ARM service layers | Standard Events | 0.90 USD |
|virtualmachines | microsoft.security/pricings | Unassigned |  |  Security Center | NULL | Standard P2 Node | 10.44 USD |
...
|cs2100300008c8d894b | microsoft.storage/storageaccounts | US East | cloud-shell-storage-eastus |  Advanced Threat Protection | Storage | Standard Node | 3.51 USD |
|cs2100300008c8d894b | microsoft.storage/storageaccounts | US East | cloud-shell-storage-eastus |  Security Center | Microsoft Defender CSPM | Standard Node | 1.82 USD |
...
|jpatrickfulton.com | microsoft.network/dnszones | Unknown | personal-dns |  Azure DNS |  | Public Zone | 0.18 USD |
|jpatrickfulton.dev | microsoft.network/dnszones | Unknown | personal-dns |  Azure DNS |  | Public Queries | 0.00 USD |
|jpatrickfulton.dev | microsoft.network/dnszones | Unknown | personal-dns |  Azure DNS |  | Public Zone | 0.18 USD |
|backup-data-disk | microsoft.compute/disks | US North Central | personal-network |  Storage | Standard HDD Managed Disks | Disk Operations | 0.35 USD |
|backup-data-disk | microsoft.compute/disks | US North Central | personal-network |  Storage | Standard HDD Managed Disks | S30 Disks | 14.90 USD |
...
|linux-dev_osdisk | microsoft.compute/disks | US North Central | personal-network |  Storage | Standard HDD Managed Disks | S4 Disks | 0.56 USD |
|ubuntu-backup-server-spot_osdisk_1_82ad58ea1b864609a678571faedee9b3 | microsoft.compute/disks | US North Central | personal-network |  Storage | Standard HDD Managed Disks | Disk Operations | 0.58 USD |
|ubuntu-backup-server-spot_osdisk_1_82ad58ea1b864609a678571faedee9b3 | microsoft.compute/disks | US North Central | personal-network |  Storage | Standard HDD Managed Disks | S4 Disks | 0.56 USD |
|ubuntu-vpn-server-spot_osdisk | microsoft.compute/disks | US North Central | personal-network |  Storage | Standard HDD Managed Disks | Disk Operations | 0.57 USD |
|ubuntu-vpn-server-spot_osdisk | microsoft.compute/disks | US North Central | personal-network |  Storage | Standard HDD Managed Disks | S4 Disks | 0.56 USD |
...
|win-dev_osdisk | microsoft.compute/disks | US North Central | personal-network |  Storage | Standard HDD Managed Disks | S4 Disks | 0.56 USD |
...
|ubuntu-backup-server-spot | microsoft.compute/virtualmachines | US North Central | personal-network |  Security Center | Microsoft Defender CSPM | Standard Node | 1.82 USD |
|ubuntu-backup-server-spot | microsoft.compute/virtualmachines | US North Central | personal-network |  Virtual Machines | DSv2 Series VM | DS1 v2 Spot | 1.99 USD |
...
|ubuntu-vpn-server-spot | microsoft.compute/virtualmachines | US North Central | personal-network |  Security Center | Microsoft Defender CSPM | Standard Node | 1.82 USD |
|ubuntu-vpn-server-spot | microsoft.compute/virtualmachines | US North Central | personal-network |  Virtual Machines | DSv2 Series VM | DS1 v2 Spot | 1.99 USD |
...
|private.jpatrickfulton.com | microsoft.network/privatednszones | Unknown | personal-network |  Azure DNS |  | Private Zone | 0.18 USD |
|linux-dev-public-ip | microsoft.network/publicipaddresses | US North Central | personal-network |  Virtual Network | IP Addresses | Standard IPv4 Static Public IP | 1.31 USD |
|ubuntu-backup-server-spot-ip | microsoft.network/publicipaddresses | US North Central | personal-network |  Virtual Network | IP Addresses | Standard IPv4 Static Public IP | 1.31 USD |
|ubuntu-vpn-server-ip | microsoft.network/publicipaddresses | US North Central | personal-network |  Virtual Network | IP Addresses | Standard IPv4 Static Public IP | 1.31 USD |
...
|personalsiteapipreview | microsoft.storage/storageaccounts | US Central | personal-site |  Advanced Threat Protection | Storage | Standard Node | 3.51 USD |
|personalsiteapipreview | microsoft.storage/storageaccounts | US Central | personal-site |  Security Center | Microsoft Defender CSPM | Standard Node | 1.82 USD |
...
|personalsiteapistorage | microsoft.storage/storageaccounts | US Central | personal-site |  Advanced Threat Protection | Storage | Standard Node | 3.51 USD |
...
|personalsiteapistorage | microsoft.storage/storageaccounts | US Central | personal-site |  Security Center | Microsoft Defender CSPM | Standard Node | 1.82 USD |
